...
|**"optimization_direction"** *(optional)* |*string*| "minimization" or "maximization" |
...
|**"total_time_lim"** *(optional)* |*float*| Time limit in minutes for the total optimizaiton run |
...
If you only want to optmize parameters and no pulses you can use QuOCS for its advanced stopping criteria and results management.
