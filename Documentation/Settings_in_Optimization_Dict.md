...
| Sinc | $A_i  \text{sinc}(2 \pi \omega_\text{max} (t-t_i))= A_i \frac{\sin(2 \pi \omega_\text{max} (t-t_i))}{2 \pi \omega_\text{max} (t-t_i)}$ |<img src="https://github.com/Quantum-OCS/QuOCS/assets/47388967/19369567-e1c2-400d-906b-834c2bc5af78" width="50%" height="50%"> <br/>*(image: By Chou https://www.semanticscholar.org/paper/Orthogonal-Basis-Functions-in-Discrete-Time-and-to-Chou/2a1a70fa3e64f17feabf575ef71dc48caa1081b3)*|
