...
## Add a new algorithm
To add a new algorithm in the QuOCS library, you need to install the software in the editable mode as explained in the [README](https://github.com/Quantum-OCS/QuOCS/blob/develop/README.md).
