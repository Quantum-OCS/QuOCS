...
def test_dCRAB_with_maximization():
    ...
    optimization_dictionary = {
        ...
        "optimization_client_name": 
            "Optimization_dCRAB_test_maximization_with_re_eval",
        "algorithm_settings": {
...
def test_dCRAB_with_minimization():
    ...
    optimization_dictionary = {
        ...
        "Do not use this json file for optimization",
        "optimization_client_name":
            "Optimization_dCRAB_test_minimization_with_re_eval",
        "algorithm_settings": {
            "algorithm_name": "dCRAB",
            "super_iteration_number": 3,
            "max_eval_total": 1000,
...
def test_dCRAB_with_maximization_prelim_stop():
    ...
    optimization_dictionary = {
        ...
        "Do not use this json file for optimization",
        "optimization_client_name": 
            "Optimization_dCRAB_test_maximization_with_re_eval_and_preliminary_FoM_goal",
        "algorithm_settings": {
            "algorithm_name": "dCRAB",
            "super_iteration_number": 3,
            "max_eval_total": 1000,
...
def test_dCRAB_with_minimization_prelim_stop():
    ...
    optimization_dictionary = {
        ...
        "Do not use this json file for optimization",
        "optimization_client_name":
            "Optimization_dCRAB_test_minimization_with_re_eval_and_preliminary_FoM_goal",
        "algorithm_settings": {
            "algorithm_name": "dCRAB",
            "super_iteration_number": 3,
            "max_eval_total": 1000,
