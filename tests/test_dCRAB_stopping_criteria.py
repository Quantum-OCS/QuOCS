...
def test_stopping_with_fatol():

    optimization_dictionary = {
        "optimization_client_name":
        "Check_fatol_stopping_crit",
        "algorithm_settings": {
            "algorithm_name": "dCRAB",
            "super_iteration_number": 3,
            "max_eval_total": 100000,
            "total_time_lim": 100000,
            "dsm_settings": {
                "general_settings": {
                    "dsm_algorithm_name": "NelderMead",
                    "is_adaptive": True
...
def test_stopping_with_frtol():

    optimization_dictionary = {
        "optimization_client_name":
        "Check_frtol_stopping_crit",
        "algorithm_settings": {
            "algorithm_name": "dCRAB",
            "super_iteration_number": 3,
            "max_eval_total": 100000,
...
def test_stopping_with_fatol_cmaes():

    optimization_dictionary = {
        "optimization_client_name":
        "Check_fatol_stopping_crit_with_CMAES",
        "algorithm_settings": {
            "algorithm_name": "dCRAB",
            "super_iteration_number": 3,
            "max_eval_total": 100000,
