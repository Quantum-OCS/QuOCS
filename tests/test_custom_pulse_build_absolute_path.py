...
def test_custom_pulse_build_abs_path():
    optimization_dictionary = {
        "Disclaimer":
        "Do not use this json file for optimization",
        "optimization_client_name":
        "Optimization_test_custom_pulse_build_abs_path",
        "algorithm_settings": {
    ...
    curr_file_dir = os.path.realpath(os.path.dirname(__file__))
    functions_file = os.path.join(curr_file_dir, "my_file_with_functions.py")

    optimization_dictionary["pulses"][0]["initial_guess"]["file_path"] = functions_file
    optimization_dictionary["pulses"][0]["scaling_function"]["file_path"] = functions_file
...
if __name__ == "__main__":
    test_custom_pulse_build_abs_path()
