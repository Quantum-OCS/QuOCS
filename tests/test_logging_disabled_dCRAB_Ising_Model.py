...
def test_dCRAB_Ising_Model_with_disabled_logging_in_console():
    optimization_dictionary = {
        "Disclaimer":
        "Do not use this json file for optimization",
        "optimization_client_name":
        "Optimization_dCRAB_IsingModel_with_disabled_logging_in_console",
        "console_info": False,
        "algorithm_settings": {
...
if __name__ == "__main__":
    test_dCRAB_Ising_Model_with_disabled_logging_in_console()
