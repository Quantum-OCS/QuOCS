...
def test_drift_compensation_average_3_FoM_minimization():
    ...
    optimization_dictionary = {
        ...
        "Check_drift_compensation_average_3_FoM_minimization",
        "algorithm_settings": {
...
def test_drift_compensation_average_3_FoM_maximization():

    optimization_dictionary = {
        "optimization_client_name":
        "Check_drift_compensation_average_3_FoM_maximization",
        "algorithm_settings": {
            "algorithm_name": "dCRAB",
