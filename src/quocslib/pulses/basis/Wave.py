...
class Wave(ChoppedBasis):
    """
    Class for the Wave basis. It inherits from the ChoppedBasis class.
    """
    ...
    def __init__(self, map_index: int, pulse_dictionary: dict, rng: RandomNumberGenerator = None, is_AD: bool = False):
        """
        Constructor of the Wave basis class. It calls the constructor of the parent class ChoppedBasis.
        ...
        # define basis specific parameter
