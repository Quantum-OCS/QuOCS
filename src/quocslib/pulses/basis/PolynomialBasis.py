...
class PolynomialBasis(ChoppedBasis):
    """
    ...
    def __init__(self, map_index: int, pulse_dictionary: dict, rng: RandomNumberGenerator = None, is_AD: bool = False):
        """
        Constructor of the Polynomial Basis class. It calls the constructor of the parent class ChoppedBasis.
        ...
        self.control_parameters_number = 1 * self.super_parameter_number
        #################
