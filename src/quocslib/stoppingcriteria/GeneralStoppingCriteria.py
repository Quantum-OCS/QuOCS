...
class GeneralStoppingCriteria(StoppingCriteria):
    """
    ...
    def check_stopping_criteria(self, sim: np.array = None, fsim: np.array = None, func_evaluations_single_direct_search: int = None) -> None:
        """
